          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gradient-to-br from-purple-500 to-blue-600 rounded-lg flex items-center justify-center">
              <svg className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0112 15a9.065 9.065 0 00-6.23.693L5 4.5m14.8.8l1.402 1.402c1.232 1.232.65 3.318-1.067 3.611A48.309 48.309 0 0112 21c-2.773 0-5.491-.235-8.135-.687-1.718-.293-2.3-2.379-1.067-3.61L5 14.5" />
              </svg>
            </div>
            <div>
          ...
          <div className="border-t border-pl-border bg-pl-navy p-4">
            <div className="flex gap-3">
              <input
                ...
                placeholder="Ask about any Rocksary workflow..."
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="events-db">Events DB</option>
                    <option value="attractions">Attractions</option>
                    <option value="tools">Tools</option>
                    <option value="optimiser">Optimiser</option>
                    <option value="qa-tagging">QA Tagging</option>
                    <option value="b2b-tov">B2B TOV</option>
                    <option value="b2c-tov">B2C TOV</option>
                  </select>
                </div>
              </div>
